...
def bblos_main(address):
    ...
    odomsg = Odometry()
    odomsg.header.frame_id = "robot_base"
    ...
    while not rospy.is_shutdown():
        ...
        try:
            ...
            # old
            if (tstamp.to_sec() - lastreqtime) > timeout:
                velreq = 0.0
                omerareq = 0.0
            ...
            if testPlatform:
                ...
                assert (not math.isnan(velreq))
                assert (not math.isnan(omegareq))
